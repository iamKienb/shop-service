...
import (
	...
	"shop-worker-module/internal/bootstrap/module"
	"sync"
...
func (a *App) Start(ctx context.Context) error {
	cfg, err := configx.Loader[config.ShopWorkerConfig]()
	...
	a.logger.Info("starting shop worker", slog.Any("topics", cfg.Consumer.Topics))
